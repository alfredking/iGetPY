...
import time
# browser = webdriver.Chrome('/Users/cmcc/PycharmProjects/iGet/chromedriver')  # mac使用
browser = webdriver.Chrome('C:\\Users\\alfredking\\PycharmProjects\\iGetPY\\chromedriver.exe')  # Windows使用
...
def add_follow(uid):
    ...
    time.sleep(1)
    # 选择分组
    group_button = browser.find_element_by_xpath('//a[@class="m-btn m-btn-white m-btn-text-orange"]')
    group_button.click()
    time.sleep(1)
